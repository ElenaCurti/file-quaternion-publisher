...
public:
    ImageSubscriber() : Node("image_subscriber")
    {
        ...
        subscription2_ = this->create_subscription<sensor_msgs::msg::CompressedImage>(
            "/camera/right_image",
            qos,
...
private:
    ...
    void image1_callback(const sensor_msgs::msg::CompressedImage::SharedPtr msg)
    {
        try
        {
    ...
    void image2_callback(const sensor_msgs::msg::CompressedImage::SharedPtr msg)
    {
        try
        {
            // Convert compressed image to OpenCV format
    ...
    rclcpp::Subscription<sensor_msgs::msg::CompressedImage>::SharedPtr subscription2_;
    ...
    std::string main_dir = "/media/castor/T9/bags_09_04_24/prova1_lr_09_04_24_estratte/"; // Path in cui salvare tutto. METTI LO / FINALE 
